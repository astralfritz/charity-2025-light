...
const u8 gText_ThisIsAPokemon[] = _("You of course know of “POKéMON.”{PAUSE 96}\p");
...
const u8 gText_TrainerCardPokedex[] = _("BATTLES WON");
...
const u8 gText_SavingBadges[] = _("BATTLES WON");
