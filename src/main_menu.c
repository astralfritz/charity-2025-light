...
static void Task_NewGameBirchSpeech_PickYourFirstPokemon(u8);
static void Task_NewGameBirchSpeech_ReshowBirchLotadAgain(u8);
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAgainAndTextPrinter(u8);
...
static const u8 gText_ContinueMenuBadges[] = _("BATTLES WON");
...
static void MainMenu_FormatSavegameBadges(void)
{
    ...
    battlesWon = VarGet(VAR_CHARITY_BATTLES_WON);
    ...
    ConvertIntToDecimalStringN(str, battlesWon, STR_CONV_MODE_LEADING_ZEROS, 1);
