...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_CHARITY_Light, TRAINER_CHARITY_Chibisama666, TRAINER_CHARITY_BansheeThey, TRAINER_CHARITY_Prue, TRAINER_CHARITY_CrimsonLobo, MAP_ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_CHARITY_TheMaddyMonster, TRAINER_CHARITY_Enomorie, TRAINER_CHARITY_Pastrieman, TRAINER_CHARITY_digisparkks, TRAINER_CHARITY_Clover, MAP_MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(TRAINER_CHARITY_AxoloDyl, TRAINER_CHARITY_Gamekxnd, TRAINER_CHARITY_Tsuki_Rae, TRAINER_CHARITY_Sinners, TRAINER_CHARITY_gamerazillakong, MAP_ROUTE102),
    ...
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_JAMIN_1, TRAINER_JAMIN_2, TRAINER_JAMIN_3, TRAINER_JAMIN_4, TRAINER_JAMIN_5, MAP_ROUTE110),
