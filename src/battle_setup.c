...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_CHARITY_Light, TRAINER_CHARITY_Chibi, TRAINER_CHARITY_Gwen, TRAINER_CHARITY_Prue, TRAINER_CHARITY_Lobo, MAP_ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_CHARITY_Maddy, TRAINER_CHARITY_Enomorie, TRAINER_CHARITY_Pastrieman, TRAINER_CHARITY_digi, TRAINER_CHARITY_Clover, MAP_MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(TRAINER_CHARITY_AxoloDyl, TRAINER_CHARITY_Gamekxnd, TRAINER_CHARITY_Tsuki_Rae, TRAINER_CHARITY_Sinners, TRAINER_CHARITY_Nate, MAP_ROUTE102),
